...
def generateGraph(graphProdData, graphConsumeData, graphDailyProdData, minuteDots):
...
def main():
   ...
   graphProdResponse = getGraphData('/api/datasources/proxy/uid/grafanacloud-prom/api/v1/query_range', 'solar_prod_wnow', startTime, endTime)
   graphConsumeResponse = getGraphData('/api/datasources/proxy/uid/grafanacloud-prom/api/v1/query_range', 'solar_consume_wnow', startTime, endTime)
   ...
   generateGraph(graphProdResponse['data']['result'][0]['values'], graphConsumeResponse['data']['result'][0]['values'], graphDailyProdResponse['data']['result'][0]['value'][1], minuteDots)
